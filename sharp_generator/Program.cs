...
internal class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        // var c2CSProcessStartInfo = new ProcessStartInfo("dotnet",
        //     "run generate --config E:\\projekte\\LibGodotSharp\\GodotSharpGDExtension.CSharp\\CAstFfi\\config-generate-cs.json");
        //
        // c2CSProcessStartInfo.WorkingDirectory = "E:\\projekte\\c2cs\\src\\cs\\production\\C2CS.Tool";
        // // processStartInfo.RedirectStandardOutput = true;
        // // processStartInfo.RedirectStandardError = true;
        //
        // Process process = Process.Start(c2CSProcessStartInfo);
        //
        // if (process is null)
        // {
        ...
        var swigBaseArguments = $"-csharp -c++ -dllimport bin/fsharp -outcurrentdir";
        ...
        // swigProcessStartInfo.Arguments = "-csharp -c++ -dllimport fsharp -outdir ../../GodotSharpGDExtension.CSharp/Generated ./string_name.i";
        //
